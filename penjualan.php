...
<p><a href="laporanpenjualan.php" class="btn btn-default">Laporan Penjualan</a></p>
<p><a href="?p=penjualan&aksi=entri" class="btn btn-primary">Tambah data</a></p>
<div class="col-sm-5" >
...
<table class="table table-condensed" id="tabeljenisbarang">
  ...
  <tbody>
    ...
    <?php
            ...
            ?>
		<td><a href="aksi_penjualan.php?proses=hapus&kode=<?php echo $row['faktur'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure ?')">Hapus</a>
		<a href="?p=penjualan&aksi=edit&kode=<?php echo $row['faktur'] ?>" class="btn btn-primary">Edit</a>
    <?php
      }
      ?>
		</td>
...
<form class="form-horizontal" role="form" action="aksi_penjualan.php?proses=tambah" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="text" class="form-control txtnofaktur"  id="txtnofaktur"  name="txtnofaktur"   readonly value="<?= $faktur ?>">
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4"> 
      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success">Tambah Barang
              </button>  
    </div>
    <div class="col-sm-3">
...
<table class="table table-condensed" id="tabeldetail">
  ...
  $today = date('ymd');
  $cari_faktur = mysqli_query($koneksi,"select max(faktur) as last from penjualan where faktur like '$today%'");
  ...
  $data1=mysqli_query($koneksi,"SELECT * FROM detail_penjualan,barang where detail_penjualan.id_barang=barang.id_barang and faktur like '$faktur'");
  $no=1;
...
<div class="modal modal-success fade" id="modal-success">
          <div class="modal-dialog">
            <div class="modal-content">
              <form class="form-horizontal" role="form" action="tambahdetailbarang.php?proses=tambah" method="post">
              ...
              <div class="modal-body">
                <div class="modal-body">
                  <div class="form-group">
                      <label for="jurusan" class="col-sm-2 control-label" style="display: none;">No Faktur</label>
                      <?php
                      include "nofaktur.php"
                      ?>
                      <div class="col-sm-4">

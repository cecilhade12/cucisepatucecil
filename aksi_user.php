...
if (isset($_POST['btnSubmit'])) {
	...
	if(!empty($nama_file)){
		if($tipe_file =="image/jpeg" or $tipe_file == "image/png"){
			$simpan=mysqli_query($koneksi,"INSERT INTO user (username,password,level,email,telp,photo) values('$_POST[username]',md5('$_POST[password]'),'$_POST[level]','$_POST[email]','$_POST[telp]','$nama_file')");
			if ($simpan){

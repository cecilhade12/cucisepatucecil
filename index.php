...
$ambil=mysqli_query($koneksi,"select * from user where username='$_SESSION[user]'");
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="images/<?php echo $data['photo']?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $data['username']?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="images/<?php echo $data['photo']?>" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="?p=bahan">
            <i class="fa fa-th"></i> <span>Bahan</span>
            <span class="pull-right-container">

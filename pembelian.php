...
<p><a href="laporanpembelian.php" class="btn btn-default">Laporan Pembelian</a></p>
...
<form class="form-horizontal" role="form" action="aksi_pembelian.php?proses=tambah" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="date" class="form-control" id="tgl_pembelian"  name="tgl_pembelian" value="<?= date("ymd")?>">
    </div>
  </div>

  <div class="form-group">
    <label for="jurusan" class="col-sm-2 control-label">Supplier</label>
    <div class="col-sm-3">
...
$koneksi=mysqli_connect('localhost','root','','db_iventory');
$ambil1=mysqli_query($koneksi,"SELECT * FROM pembelian WHERE faktur='$_GET[kode]'");
...
<table class="table table-condensed" id="tabeldetail">
  ...
  <?php
  $koneksi=mysqli_connect('localhost','root','','db_iventory');
  $data2=mysqli_query($koneksi,"SELECT * FROM detail_pembelian,barang where detail_pembelian.id_barang=barang.id_barang and faktur like '$_GET[kode]'");
  $no=1;
